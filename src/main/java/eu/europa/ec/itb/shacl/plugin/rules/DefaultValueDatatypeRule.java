...
public class DefaultValueDatatypeRule extends JenaModelUtils  implements Rules {
	...
	public void validateRule() {
		int warnings = 0;
    	Property defaultValueProperty = this.currentModel.getProperty(defaultValue);
    	Property datatypeProperty = this.currentModel.getProperty(datatypeURI);
    	Property classProperty = this.currentModel.getProperty(classURI);
    	
    	ResIterator itSubjects = this.currentModel.listSubjectsWithProperty(defaultValueProperty);
